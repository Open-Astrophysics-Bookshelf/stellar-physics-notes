...
\begin{exercisebox}[Pressure for an isotropic gas]
...
\begin{exercisebox}[The chemical potential in an external field]
...
Let's forge on a little further, though, and try to get the energy per unit volume $u$.  Once we have $u$, we know we can get the pressure from the relation for a non-relativistic gas, $P = 2/3\;u$.  Using equations~(\ref{e.u}) and (\ref{e.fermion}),
\begin{equation}
...
\begin{exercisebox}[First-order corrections to the Maxwell-Boltzmann gas]
...
\begin{exercisebox}[Onset of degeneracy]
...
\begin{exercisebox}[Entropy of thermal radiation]
...
\begin{exercisebox}[Half-ionization temperature of hydrogen]
\begin{enumerate}
...
\begin{exercisebox}[Relative strength of magnetic interaction]
...
\newpage
\begin{exercisebox}[Screening in a plasma]
\begin{enumerate}
...
\begin{exercisebox}[Coulomb pressure and the mass-radius relation of cold bodies]
\begin{enumerate} 
