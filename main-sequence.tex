...
\item We showed that on the upper-main sequence, the strong temperature sensitivity of the CNO cycle makes the radius scale nearly linearly with mass, and the effective temperature very weakly dependent on luminosity (cf.\ eqns.\ [\ref{e.R-M-upperMS}]--[\ref{e.Teff-L-upperMS}]).  Suppose that there were no CNO cycle, and hydrogen could only be consumed via the PP chains.  Estimate the effective temperature-luminosity relation for the upper main-sequence in this case.  Would it be observationally distinguishable from the CNO-dominated upper MS?
\end{enumerate}
