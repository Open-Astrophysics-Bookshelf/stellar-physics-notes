% !TEX root = ./notes.tex
\chapter{Post-Main Sequence Evolution: Low-mass stars}
...
\section{Exercises}\label{s.agb-exercises}
...
\item Assuming the surface effective temperature on the AGB is fixed at $4000\nsp\K$, solve equation~(\ref{e.wind-loss}), using the result of problem~\ref{p.core-mass-growth} to get the luminosity as a function of core mass, for the \emph{total} stellar mass as a function of time.  Take the initial mass at the start of the AGB phase to be $M_{0}$.
