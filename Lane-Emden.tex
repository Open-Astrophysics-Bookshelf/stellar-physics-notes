...
\begin{figure}[htbp]
\centering{\includegraphics[width=4in]{Figures/LE_all.pdf}}
...
\item\label{p.radius-entropy} For a fully convective star with an ideal gas equation of state, how is the polytropic constant $K$ related to the entropy? Derive a formula for $R$ in terms of $M$ and $s$ in this case.  What happens to the star if the entropy increases, i.e., heat is added to it?
