...
The notes include exercises using the \mesa\ stellar evolution code, available from \url{http://mesa.sourceforge.net/}.  The exercises are prefaced with the symbol \raisebox{0pt}{\includegraphics[height=1.4ex]{mesa_logo2_30pt}}.
