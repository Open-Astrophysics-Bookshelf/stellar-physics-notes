...
For this exercise, we don't need any custom output, so we are just using the standard '|run_star_extras.f90|' file.  We still need to compile the code, however, so do `|./mk|'.
