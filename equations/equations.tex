...
\NA = 6.0221367\ee{23}\nsp\unitstyle{mol}^{-1}.
\end{equation}
\marginnote{Recall that a \newterm{mole} is an amount of something: in $1\nsp\unitstyle{mol}$ there are $\NA$ items.}
