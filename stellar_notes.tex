...
~\vfill
\thispagestyle{empty}
\par The cover image is the starfield around the second closest star to Earth, Proxima Centauri.  Credit \& Copyright: David Malin, UK Schmidt Telescope, DSS, AAO
\end{fullwidth}
