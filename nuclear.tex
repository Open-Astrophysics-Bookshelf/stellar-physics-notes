...
\end{equation}
Here $A = N+Z$ and masses are in MeV, so $m_{p} = 938.272\nsp\MeV$ and $m_{n} = 939.565\nsp\MeV$. Using the online fitting routine from the \href{http://128.95.95.61/~intuser/ld.html}{Institute for Nuclear Theory}, I obtained the coefficients listed in Table~\ref{t.liquid-drop}.
