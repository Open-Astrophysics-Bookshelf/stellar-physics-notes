...
\begin{marginfigure}
\includegraphics[width=\linewidth]{shear-diagram}
...
\begin{exercisebox}[Conditions for which viscosity matters]
 Estimate the ratio of the pressure to viscous accelerations,
\[ \frac{|\rho^{-1}\grad P|}{|\nu\nabla^{2}\vu|} ,\]
...
An identical procedure, but replacing the average momentum of a particle with its average thermal energy, yields an expression for the \emph{thermal conductivity} $K$, such that the heat flux is
...
\begin{exercisebox}[Strength of heat conduction in the solar center]
 Estimate the plasma thermal conductivity under conditions appropriate to the solar center. How does heat conduction by the electrons compare to that by photons?
